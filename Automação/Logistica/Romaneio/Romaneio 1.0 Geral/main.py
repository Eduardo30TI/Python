...
def Analise(tabelas_df):
    ...
    <p>Segue a relação referênte ao mês de {mes_nome.title()} de {ano} foi gasto com frete R$ {frete} o total de notas faturado foi de R$ {valor} cerca de {percentual:.2%}</p>
    ...
    if(pedido>0):
        ...
        assunto=(f'Entregas de {mes_nome.title()} de {ano}')
