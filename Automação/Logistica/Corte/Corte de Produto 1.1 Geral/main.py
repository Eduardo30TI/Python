    ...
    for coluna,email in emails.items():
        ...
        for env in email:
            ...
            if(coluna=='E-mail'):
                ...
                <p>Relação referênte a {meses[mes].title()} de {ano} cerca de {sku} itens que foram cortados. Totalizando R$ {total}</p>
                ...
                assunto=f'Corte de Produto referênte a {meses[mes]} de {ano}'
                ...
                Email.EnviarEmail(corpo=menssagem,assunto=assunto,kwargs=temp_dict)
